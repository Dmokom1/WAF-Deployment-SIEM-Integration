...
### Elastic Custom Detection Rule

To automate the detection of SafeLine-blocked attacks, a custom query rule was engineered in Elastic to match the specific attack_type codes logged by SafeLine:

- attack_type: 0 = SQL Injection
- attack_type: 1 = Cross-Site Scripting (XSS)
- attack_type: 9 = Command Injection
- attack_type: 11 = Local File Inclusion (LFI)

The rule logic: message: "attack_type: 0" OR message: "attack_type: 1" OR message: "attack_type: 9" OR message: "attack_type: 11"

This rule fires whenever any of the four attack vectors are detected in the log stream, allowing for automated alerting and incident response workflows.
...
- **screenshots/**: Evidence images (11 total)
  ...
  - 07_Elastic_Detection_Rule_Configuration.png
